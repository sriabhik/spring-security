...
import com.anudip.entities.JwtRequest;
import com.anudip.entities.JwtResponse;
import com.anudip.exceptions.InvalidUser;
import com.anudip.security.JwtHelper;
...
//            System.out.println("Inside doAuthe");
            ...
            throw new InvalidUser(email,password);
        }
    }
